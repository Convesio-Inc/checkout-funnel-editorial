...
export function GuaranteeCard() {
  return (
    <section data-section="guarantee" aria-labelledby="guarantee-heading" className="grid grid-cols-[120px_1fr] gap-8 py-10 border-t border-line">
      <Seal />
      <div>
        <div className="smallcaps text-[10.5px] text-ink3">The Empty-Bottle Promise</div>
        <h3 id="guarantee-heading" className="serif italic text-[34px] leading-[1.05] mt-2 text-ink max-w-[34ch]">
